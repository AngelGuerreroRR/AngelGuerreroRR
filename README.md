...
- **Biomedical Engineer – Hospital Star Médica Pedregal**  
  Responsible for equipment maintenance, calibration, and integration of surgical navigation systems, patient simulators, and imaging devices.
  
- **Teaching Faculty – Instituto Tecnológico del Valle / IBERO**  
  *Courses:* Probability & Statistics, Applied Mathematics for Business, and Calculus for Engineers.  
  Designed course materials, problem banks, and data-driven examples for logistics, hospitality, and engineering students.

- **Biomedical Engineer – Hospital Ángeles Clínica Londres**  
...
![ShaderLab](https://img.shields.io/badge/ShaderLab-000000?style=flat&logo=unity&logoColor=white)
